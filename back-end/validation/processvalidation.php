...
if (isset($_POST['submit'])) {
    if (isset($_POST['selected_ids']) && !empty($_POST['selected_ids'])) {
        ...
        $query = "SELECT `id`, `student_id`, `account_name`, `last_name`, `created_at`
                  FROM `account_validation` 
        ...
        while ($row = mysqli_fetch_assoc($selectedResult)) {
            ...
            $insertQuery = "INSERT INTO `valid_account` (`id`, `student_id`, `account_name`, `last_name`, `created_at`) 
                            VALUES ('$id', '$student_id', '$account_name', '$last_name', '$created_at')";
