...
<body style="background: #efefef;border-radius: 22px;">
    ...
    <div class="container" style="margin-top: 141px;">
        <div class="row justify-content-around">
            ...
            <!--Timer-->
            <div
                style="position: fixed; bottom: 30px; right: 50px; text-align: right; width: auto; padding: 10px; background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(10px); font-size: 55px; font-family: 'Arial', sans-serif; margin-top:50px;">
