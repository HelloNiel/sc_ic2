    ...
    <div class="card" style="width: 100%; max-width: 500px;">
      <div class="card-body">
        ...
        <form action="../../back-end/registerquery.php" method="POST" id="register">
          ...
          <div class="mb-3">
            <label for="accountName" class="form-label">First Name</label>
            <input type="text" name="AccountName" id="accountName" class="form-control" placeholder="Enter First Name" required />
          </div>
